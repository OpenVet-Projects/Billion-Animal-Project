...
export const OWE_ITEMS: OweItem[] = [
  ...
  },
  {
    ...
    body: "This is a vow made in public, against the clock, knowing we will be held to it. One billion records. Longer, healthier lives. What endures is pride in becoming the kind of civilization that remembers its animals.",
