...
export const LIFESPAN_TABS: LifespanTab[] = [
  {
    ...
    body: "A platform that aggregates millions of cases can identify which breeds are predisposed, which early signs are missed, and which interventions work — and at what stage.",
  },
  {
    n: "02",
    title: "CROSS-SPECIES",
  ...
  },
  {
    ...
    body: "We route what works — parasites, nutrition, treatments — regardless of where it originated.",
  },
  {
    n: "05",
